...
interface DetectorChooserProps {
  ...
  createDetectorSelection: CREATE_HISTORICAL_DETECTOR_OPTIONS;
  setCreateDetectorSelection(
    selection: CREATE_HISTORICAL_DETECTOR_OPTIONS
  ): void;
      ...
      >
        <EuiFlexItem style={{ marginRight: '4px' }}>
          <EuiCheckableCard
            ...
            value={CREATE_HISTORICAL_DETECTOR_OPTIONS.USE_EXISTING}
            checked={
              props.createDetectorSelection ===
              CREATE_HISTORICAL_DETECTOR_OPTIONS.USE_EXISTING
            }
            onChange={() => {
              props.setCreateDetectorSelection(
                CREATE_HISTORICAL_DETECTOR_OPTIONS.USE_EXISTING
              );
              populateDetectorFieldsToInitialValues(props.formikProps);
        ...
        <EuiFlexItem style={{ marginLeft: '4px' }}>
          <EuiCheckableCard
            ...
            value={CREATE_HISTORICAL_DETECTOR_OPTIONS.CREATE_NEW}
            checked={
              props.createDetectorSelection ===
