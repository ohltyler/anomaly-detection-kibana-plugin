...
export enum HISTORICAL_DETECTOR_STATE_COLOR {
  DISABLED = '#98A2B3',
  RUNNING = 'primary',
  COMPLETED = '#7DE2D1',
  FAILED = '#F66',
...
export const historicalDetectorStateToColorMap = new Map<
  HISTORICAL_DETECTOR_STATE,
  HISTORICAL_DETECTOR_STATE_COLOR
>()
  .set(
    HISTORICAL_DETECTOR_STATE.DISABLED,
    HISTORICAL_DETECTOR_STATE_COLOR.DISABLED
  )
  .set(
    HISTORICAL_DETECTOR_STATE.RUNNING,
    HISTORICAL_DETECTOR_STATE_COLOR.RUNNING
  )
  .set(
    HISTORICAL_DETECTOR_STATE.COMPLETED,
    HISTORICAL_DETECTOR_STATE_COLOR.COMPLETED
  )
  .set(
    HISTORICAL_DETECTOR_STATE.FAILED,
    HISTORICAL_DETECTOR_STATE_COLOR.FAILED
  );

export const ALL_DETECTOR_STATES = [];
export const ALL_HISTORICAL_DETECTOR_STATES = [];
